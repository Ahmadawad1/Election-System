...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> makePostRequest() async {
    var urlPrefix =
        'https://electionsystembackend.azurewebsites.net/Auth/VoterLogin?id=' +
            idController.text +
            '&password=' +
    ...
    switch (response.body) {
      ...
      case "2":
        {
          GlobalValues.setLoginStatus(idController.text);
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => CandidateDetails()));
          break;
        }
      case "4":
        {
